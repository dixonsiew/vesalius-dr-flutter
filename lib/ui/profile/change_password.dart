...
import 'package:vesalius_dr_flutter/controllers/profile/change_password_ctrl.dart';
...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  void onSubmit() async {
    try {
      ...
      if (x == '200') {
        showCustomDialog('Password successfully changed', AlertType.success);
      }
    }
    ...
    on DioException catch (error) {
      ...
      if (error.response?.statusCode == 417) {
        showCustomDialog('New Password is not allowed to be the same with Current Password', AlertType.info);
      }
      ...
      ctrl.setIsLoading(false);
      showCustomDialog('Invalid password', AlertType.error);
    }
  }
